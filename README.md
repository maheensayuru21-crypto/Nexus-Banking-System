...
It is integrated with the **[Nexus Chat Server](https://github.com/maheensayuru/Nexus-Chat-Server)**, allowing users to securely query their database balances (`/balance`) and execute live, multi-threaded SQL transactions (`/transfer`) directly through an encrypted JavaFX chat interface.

## ⚙️ Setup & Installation
1. Clone the repository: `git clone https://github.com/maheensayuru/Nexus-Banking-System.git`
